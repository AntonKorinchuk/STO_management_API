...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role", sa.Enum("ADMIN", "MECHANIC", name="mechanicrole"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_mechanics_mechanic_id"), "mechanics", ["mechanic_id"], unique=False
    )
    op.create_table(
        "services",
    ...
    op.create_index(
        op.f("ix_services_service_id"), "services", ["service_id"], unique=False
    )
    op.create_table(
        "users",
